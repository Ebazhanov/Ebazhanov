...
I'm **Evgenii Bazhanov** — a 🧪 Senior (Lead) QA Automation Engineer focused on UI and API testing (🎭 Playwright, 🌿 Cypress: TypeScript), with an additional interest in 🛠️ DevOps topics (☁️ GCP, 🔁 CI/CD, 🚀 Cloud Run).
